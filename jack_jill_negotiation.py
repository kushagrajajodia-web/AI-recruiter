...
TRANSCRIPT_FILE = "jack_jill_conversation.md"
...
def main():
    ...
    for job in jobs:
        ...
        You are in a boardroom with Jack (Candidate Agent).
        ...
        if not internal_matches_found:
            log_to_transcript("SYSTEM", "❌ No strong matches (\u003e8/10) found for this position.")
